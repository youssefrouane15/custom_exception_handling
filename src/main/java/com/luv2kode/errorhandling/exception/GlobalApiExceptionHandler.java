package com.luv2kode.errorhandling.exception;

import com.luv2kode.errorhandling.exception.dto.ErrorResponseDto;
import com.luv2kode.errorhandling.exception.dto.InvalidParameterDto;
import com.luv2kode.errorhandling.exception.util.ErrorResponseUtil;
...
import static com.luv2kode.errorhandling.exception.util.ErrorResponseUtil.build;
...
public class GlobalApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCustomUncaughtApplicationException(final ApplicationException ex,
                                                                           final ServletWebRequest request) {
        log(ex, request);
        final ErrorResponseDto errorResponseDto = ErrorResponseUtil.build(ex.getCode(), ex.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponseDto);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(final ConstraintViolationException ex,
        ...
        final ErrorResponseDto errorResponseDto = ErrorResponseUtil.build(ConstraintViolationException.class.getSimpleName(),
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(final HttpMessageNotReadableException ex,
        ...
        final ErrorResponseDto errorResponseDto = ErrorResponseUtil.build(HttpMessageNotReadableException.class.getSimpleName(), ex.getMessage(),
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
        ...
        log(ex, (ServletWebRequest) request);
        final ErrorResponseDto errorResponseDto = ErrorResponseUtil.build(HttpRequestMethodNotSupportedException.class.getSimpleName(), ex.getMessage(),
    ...
    protected ResponseEntity<Object> handleServletRequestBindingException(final ServletRequestBindingException ex,
        ...
        final ErrorResponseDto errorResponseDto = ErrorResponseUtil.build(ServletRequestBindingException.class.getSimpleName(),
